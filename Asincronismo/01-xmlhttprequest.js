...
const ExplicXMLHTTPRequest = require('xmlhttprequest').XMLHttpRequest; 
...
/*Esta Para validar soluciones y errores que puede y va a haber, va a regresar muchos valores en el cambio en el inicio hasta pasar en el que estamos buscando  */
}
